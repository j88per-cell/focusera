    ...
    <div class="w-full max-w-6xl mx-auto p-6">
      <div class="mb-6 flex items-center justify-between">
        <div>
          ...
          <p v-if="gallery.attribution" class="text-sm text-slate-300 mt-1">Attribution: {{ gallery.attribution }}</p>
          <p v-if="gallery.notes" class="text-sm text-slate-400 whitespace-pre-line mt-1">{{ gallery.notes }}</p>
        </div>
      ...
      <div v-else-if="!childGalleries.length" class="text-muted-foreground">No photos in this gallery yet.</div>

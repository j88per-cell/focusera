    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="hidden md:flex items-center gap-4">
          <a
            href="/"
            class="hover:text-accent px-3 py-2 text-sm"
          >Home</a>
          <a
            href="/galleries"
            class="hover:text-accent px-3 py-2 text-sm"
          ...
          <template v-if="!user">
            <button
              class="px-3 py-2 rounded-md text-sm bg-accent text-white hover:bg-accent/90"
            ...
            <a
              ...
              href="/register"
              class="px-3 py-2 rounded-md text-sm border border-accent hover:bg-accent/10"
            >Sign up</a>
          </template>
